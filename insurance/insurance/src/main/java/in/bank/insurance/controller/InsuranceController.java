package in.bank.insurance.controller;
	...
	public class InsuranceController {
		...
		public List<Insurance> getCustomerDetails(@RequestBody Customers customer) {
			
			List<Insurance> insurance = insuranceRepository.getByCustomerId(customer.getCustomerId());
		    return insurance;
		}
